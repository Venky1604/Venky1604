...
### 📌 Featured Projects
- **Enterprise GenAI Knowledge Assistant** – Secure RAG-based chatbot using Azure OpenAI  
- **Agentic AI Workflow Automation** – Multi-agent AI systems for task orchestration  
- **ML Monitoring & Observability** – Model performance tracking with MLflow  
- **Data Analytics Dashboards** – Business insights using Python, SQL, and BI tools  
...
- Cloud-native AI security & governance  
